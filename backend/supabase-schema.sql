...
-- Optional: keep projects empty and manage them from /admin
-- (Do not seed dummy projects — they confuse real CMS data.)
...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS for_sale BOOLEAN DEFAULT false;
