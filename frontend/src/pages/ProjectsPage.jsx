    ...
    <main className={`projects-page ${visible ? "is-visible" : ""}`}>
      <section className="projects-page__hero">
        <div className="projects-page__hero-inner">
          <span className="projects-page__label">{t("projectsPage.label")}</span>
        ...
        <div className="projects-page__content-inner">
          ...
          {loading ? (
            ...
            <div className="projects-page__empty">
              ...
              <h2>{t("projectsPage.comingSoon")}</h2>
                ...
                return (
                  ...
                  >
                        ...
                        <div className="projects-page__card-links">
                          {project.live_url && (
                            <a
                              ...
                              aria-label={t("projectsPage.viewLive")}
                            >
                          ...
                          {project.github_url && (
                            <a
                              ...
                              rel="noopener noreferrer"
                              className="projects-page__card-link"
                              aria-label={t("projectsPage.viewGithub")}
                            >
                    ...
                    <div className="projects-page__card-content">
                      <h3 className="projects-page__card-title">{title}</h3>
                      {description && (
                        <p className="projects-page__card-desc">{description}</p>
                      )}
